...
class Artikel_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_artikel,id_kategori,judul,slug_judul,isi_artikel,foto_artikel,create_by,create_date,modif_by,modif_date');
        $this->datatables->from('artikel');
        //add this line for join
        //$this->datatables->join('table2', 'artikel.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('artikel/read/$1'),'Read')." | ".anchor(site_url('artikel/update/$1'),'Update')." | ".anchor(site_url('artikel/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_artikel');
	...
	$this->db->or_like('slug_judul', $q);
	$this->db->or_like('isi_artikel', $q);
	$this->db->or_like('foto_artikel', $q);
